...
async function substituirCampos(templatePath, outputPath, replacements, body, cliente) {
    try {
        ...
        const doc = new Document({
            ...
            //             }),
            //             new Paragraph({
            //                 text: "Recomenda-se que a montagem ocorra em locais cobertos, pois a exposição à chuva pode resultar em danos aos equipamentos. A contratante assume total responsabilidade pelos danos causados aos itens contratados."
            //             }),
            //             new Paragraph({
            //                 text: "Arcar com despesas de estacionamento do CONTRATADO. Locais fechados como clubes, shoppings, buffets, etc., em que o estacionamento não for gratuito, o CONTRATANTE fica responsável pelo pagamento do estacionamento tanto para montagem como para desmontagem/retirada;"
            //             }),
            //             new Paragraph({
            //                 text: "Prover espaço adequado e condições mínimas (fonte de energia) para a instalação e fixação do Letreiro Luminoso;"
            //             }),
            //             new Paragraph({
            //                 text: "Após a realização de cada pagamento, o CONTRATANTE deverá informar e comprovar o ato ao CONTRATADO;"
            //             }),
            //             new Paragraph({
            //                 text: "CLÁUSULA 5 – DA RESCISÃO CONTRATUAL:"
            //             }),
            ...
            //             }),
            //             new Paragraph({
            //                 text: "Caso o CONTRATANTE queira cancelar ou rescindir o contrato de serviços dentro de 24 horas após o pagamento, receberá um reembolso total, em até 7 dias úteis se o pagamento tenha sido feito via PIX, e em até 30 dias se o pagamento tenha sido feito via cartão de crédito (débito, vencimento ou parcelado)."
            //             }),
            //             new Paragraph({
            //                 text: "Caso o CONTRATANTE queira cancelar ou rescindir o contrato de serviços depois dos 7 dias após assinado o contrato, concorda que só tem direito a um reembolso de 70% da quantia total acordada para os bens e/ou serviços que você cancelou, abandonando assim qualquer direito a qualquer reembolso maior."
            //             }),
            //             new Paragraph({
            //                 text: "Caso o CONTRATANTE queira cancelar ou rescindir o contrato de serviços dentro de 60 dias antes do período de locação, concorda que só tem direito a um reembolso de 50% da quantia total acordada para os bens e/ou serviços que você cancelou, abandonando assim qualquer direito a qualquer reembolso maior."
            //             }),
            //             new Paragraph({
            //                 text: "Caso o CONTRATANTE queira cancelar ou rescindir o contrato de serviços dentro de 30 dias entes do período de locação, você concorda que não tem direito a qualquer reembolso de nós em relação a esses bens e/ou serviços e você perde e abandona qualquer direito a qualquer reembolso."
            //             }),
            //             new Paragraph({
            //                 text: "Caso houver desistência por parte do CONTRATADO, deverá devolver ao CONTRATANTE todo valor pago no ato da assinatura deste contrato, acrescidos de 30% do valor do contrato, como forma de multa por possíveis perdas por parte do CONTRATANTE."
            //             }),
            //             new Paragraph({
            //                 text: "Em caso de problema técnico causado por falta de energia, algum pane elétrico do local do evento, a qual não nos permita realizar nossos serviços, não haverá devolução de valores."
            //             }),
            //             new Paragraph({
            //                 text: "CLÁUSULA 6 – ALTERAÇÃO DE DATA DO EVENTO:"
            //             }),
            ...
            //             }),
            //             new Paragraph({
            //                 text: "Utilizar e veicular as fotografias realizadas com o registro da imagem do(a) CONTRATANTE(A) no em mídias sociais do CONTRATADO, para fins de publicidade institucional e/ou de produtos contratados, sem qualquer limitação de número de inserções e reproduções;"
            //             }),
            //             new Paragraph({
            //                 text: "Utilizar as fotografias na produção de quaisquer materiais publicitários e promocionais para fins de divulgação em mídias sociais do CONTRATADO, tais como, exemplificativamente, anúncios em revistas e jornais, folhetos, cartazetes, Instagram, Facebook “posters”, filmes publicitários, “out door” e “bus door”, dentre outros, a serem veiculados;"
            //             }),
            //             new Paragraph({
            //                 text: "CLÁUSULA 8 – DISPOSIÇÕES GERAIS:"
            //             }),
            ...
            //             }),
            //             new Paragraph({
            //                 text: "Caso o contratante não realize o pagamento do restante até 30 dias corridos antes do evento, a reserva será cancelada sem aviso prévio e a data disponibilizada para novas locações."
            //             }),
            //             new Paragraph({
            //                 text: "Festas canceladas por motivos de morte de parentes de primeiro grau, doença do anfitrião ou de parentes de primeiro grau e/ou decretos governamentais (ex. Restrições por pandemia), o valor pago fica como crédito para um futuro evento, podendo ser marcado em até 6 meses desde que seja comunicado com até 30 dias de antecedência do evento."
            //             }),
            //             new Paragraph({
            //                 text: "CLÁUSULA 9 - DANOS AOS EQUIPAMENTOS"
            //             }),
